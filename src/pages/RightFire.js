...
import { FireTwo } from './fire/FireTwo';
export default class RightFire extends Component {
  constructor(props) {
    super(props)
  ...
  drawFire = () => {
    ...
    document.getElementById('rightFire').appendChild(renderer.domElement);
    // 创建场景
  ...
  componentDidMount() {
    if (WEBGL.isWebGLAvailable()) {
      ...
      document.getElementById('rightFire').appendChild(warning);
    }
  }
